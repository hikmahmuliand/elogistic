	...
	<div class="container col-md-12">
		...
		<div class="welcome-control col-md-7">
			<div class="col-md-10 offset-md-1" id="about-view">
				...
				<hr class="hr-custom">
				<span>Layanan pendistribusian logistik kepada lokasi bencana</span><br>
		...
		<div class="sign-control col-md-5">
			<div class="col-md-8 offset-md-2" id="login-view">
				<form action="" id="">
					...
					<input class="form-control col-md-10 offset-md-1" type="text" name="username" placeholder="Username" required autocomplete="">
					<input class="form-control col-md-10 offset-md-1" type="text" name="password" placeholder="Password" required autocomplete="">
					...
					<span >Create a new account<a href=""> in here</a></span>
					</div>
				</form>
			</div>
		</div>
